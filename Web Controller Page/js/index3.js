...
(function() {
  ...
  var allDraggableElements = document.querySelectorAll('.draggable-droppable2,.draggable-droppable3,.draggable-droppable5,.draggable-droppable6,.draggable-droppable7');
  dragAndDropModule(allDraggableElements);
  var allDraggableElements2 = document.querySelectorAll('.draggable-droppable,.draggable-droppable4');
  dragAndDropModule(allDraggableElements2);
